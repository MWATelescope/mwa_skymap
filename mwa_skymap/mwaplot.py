...
class SkyData(object):
    ...
    def __init__(self, logger=DEFAULTLOGGER):
        ...
        self.sources = {
            ...
            'EOR0': Source(name='EoR0', ra='00:00:00', dec='-27:00:00', fontsize=12, align='c', color='yellow', icolor='darkorange'),
            'EOR1': Source(name='EoR1', ra='04:00:00', dec='-30:00:00', fontsize=12, align='c', color='yellow', icolor='darkorange'),
            'EOR2': Source(name='EoR2', ra='10:20:00', dec='-10:00:00', fontsize=12, align='c', color='yellow', icolor='darkorange'),
            'EOR3': Source(name='EoR2', ra='01:00:00', dec='-27:00:00', fontsize=12, align='c', color='yellow', icolor='darkorange'),
            ...
            'PKS1610': Source(name='PKS 1610-60', ra='16:15:03.864', dec='-60:54:26.14'),
            'CenB': Source(name='Cen B', ra='13:46:49.0432', dec='-60:24:29.355'),
            ...
            '3C409': Source(name='3C 409', ra='20:14:27.74', dec='+23:34:58.4'),
            '3C433': Source(name='3C 433', ra='21:23:44.582', dec='+25:04:27.23'),
            'SgrA': Source(name='Sgr A*', ra='17:45:40.0409', dec='-29:00:28.118'),
            ...
            'VirA': Source(name='Vir A/M87', ra='12:30:49.42338', dec='+12:23:28.0439', align='r'),
...
def plot_MWA_skymap(delays=None,
    ...
    if gleamsources:
        ...
        size[size >= 60] = 60
        if inverse:
            gscolor = SKYDATA.gleamicolor
        else:
            gscolor = SKYDATA.gleamcolor
